...
To get started, create a [development build](https://docs.expo.dev/develop/development-builds/introduction/) for your Expo app and then install React Native Track Player.
