...
function setEraseNotificationBehaviour(erase) {
    if (Platform.OS === 'android') {
        return TrackPlayer.setEraseNotificationBehaviour(erase);
    }
}
...
module.exports.setEraseNotificationBehaviour = setEraseNotificationBehaviour;
