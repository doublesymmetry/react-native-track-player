        ...
        return async function() {
            for (let i = 0; i < events.length; i++) {
                ...
                if (eventName === 'playback-track-done') {
                    addEventListener(eventName, warpEventResponse.bind(null, handler, 'playback-track-changed'));
                }

                addEventListener(eventName, warpEventResponse.bind(null, handler, eventName));
            }
        };
    });
}
