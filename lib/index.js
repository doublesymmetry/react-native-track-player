...
import DownloadManager, {
  ...
  getDownloadDirectorySize,
} from "./media-downloader/download-manager";
import Download, {
  DOWNLOAD_STATES,
  EVENT_LISTENER_TYPES,
} from "./media-downloader/download";
...
// RepeatMode types
module.exports.REPEAT_MODE_OFF = TrackPlayer.REPEAT_MODE_OFF;
module.exports.REPEAT_MODE_ONE = TrackPlayer.REPEAT_MODE_ONE;
module.exports.REPEAT_MODE_ALL = TrackPlayer.REPEAT_MODE_ALL;
...
module.exports.setRepeatMode = TrackPlayer.setRepeatMode;
...
module.exports.getRepeatMode = TrackPlayer.getRepeatMode;
...
module.exports.addDownloadEventListener = addDownloadEventListener;
module.exports.getDownloadDirectorySize = getDownloadDirectorySize;
module.exports.DOWNLOAD_STATES = DOWNLOAD_STATES;
module.exports.DOWNLOAD_EVENT_LISTENER_TYPES = EVENT_LISTENER_TYPES;
