...
var emitter =
  react_native_1.Platform.OS !== "android"
    ? new react_native_1.NativeEventEmitter(TrackPlayer)
...
function add(tracks, insertBeforeId) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(_a) {
      ...
      if (tracks.length < 1) return [2 /*return*/];
...
function addByIndex(tracks, insertBeforeIndex) {
  return __awaiter(this, void 0, void 0, function() {
    var i;
    return __generator(this, function(_a) {
      if (!Array.isArray(tracks)) {
      ...
      return [2 /*return*/, TrackPlayer.add(tracks, insertBeforeIndex)];
    });
  });
}
...
function removeByIndex(index) {
  return __awaiter(this, void 0, void 0, function() {
    return __generator(this, function(_a) {
      ...
      return [2 /*return*/, TrackPlayer.removeByIndex(index)];
    });
  });
}

function updateTrack(id, tracks) {
  return __awaiter(this, void 0, void 0, function() {
    return __generator(this, function(_a) {
      if (!Array.isArray(tracks)) {
        tracks = [tracks];
      }
      return [2 /*return*/, TrackPlayer.updateTrack(id, tracks)];
    });
  });
}

function updateTrackbyIndex(index, tracks) {
  return __awaiter(this, void 0, void 0, function() {
    return __generator(this, function(_a) {
      if (!Array.isArray(tracks)) {
        tracks = [tracks];
      }
      return [2 /*return*/, TrackPlayer.updateTrack(index, tracks)];
    });
  });
}
...
function shuffleFromIndex(index) {
  return __awaiter(this, void 0, void 0, function() {
    return __generator(this, function(_a) {
      return [2 /*return*/, TrackPlayer.shuffleFromIndex(index)];
    });
  });
}
...
function updateMetadataForTrack(trackId, metadata) {
  return __awaiter(this, void 0, void 0, function() {
    return __generator(this, function(_a) {
      return [
        2 /*return*/,
        TrackPlayer.updateMetadataForTrack(trackId, metadata)
      ];
    });
  });
}

function updateMetadataForTrackByIndex(index, metadata) {
  return __awaiter(this, void 0, void 0, function() {
    return __generator(this, function(_a) {
      return [
        2 /*return*/,
...
function getCachedStatus(key, length) {
  return __awaiter(this, void 0, void 0, function() {
    return __generator(this, function(_a) {
      return [2 /*return*/, TrackPlayer.getCachedStatus(key,length)];
    });
  });
}

function download(key, url, length, path, forceOverWrite) {
  return __awaiter(this, void 0, void 0, function() {
    return __generator(this, function(_a) {
      return [2 /*return*/, TrackPlayer.download(key, url, length, path, forceOverWrite)];
    });
  });
}
...
function dropCache() {
  return __awaiter(this, void 0, void 0, function() {
    return __generator(this, function(_a) {
      return [2 /*return*/, TrackPlayer.dropCache()];
    });
  });
}

function removeSpans(key) {
  return __awaiter(this, void 0, void 0, function() {
    return __generator(this, function(_a) {
      return [2 /*return*/, TrackPlayer.removeSpans(key)];
    });
  });
}
...
exports.default = {
  ...
  updateTrackbyIndex: updateTrackbyIndex,
  shuffle: shuffle,
  shuffleFromIndex: shuffleFromIndex,
  move: move,
  skipbyIndex: skipbyIndex,
  updateMetadataForTrackByIndex: updateMetadataForTrackByIndex,
  setRepeatMode: setRepeatMode,
  getRepeatMode: getRepeatMode,
  download: download,
  dropCache: dropCache,
  removeSpans: removeSpans,
