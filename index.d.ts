...
declare namespace RNTrackPlayer {
  ...
  export function useTrackPlayerEvents(): void
  export function useInterval(): void
  export function useWhenPlaybackStateChanges(): void
  export function usePlaybackStateIs(): boolean
